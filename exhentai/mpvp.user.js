...
">
  <div id="fsbtn" style="
    ...
    left: 16px;
  ">
    <svg id="fsreq" width="32" height="32" viewBox="0 0 32 32">
    ...
    <svg id="fsexit" width="32" height="32" viewBox="0 0 32 32">
  ...
  <div id="playpausebox" title="Start slideshow" style="
    display: inline-block;
  ">
    <svg id="playbtn" viewBox="0 0 32 32" width="64" height="64">
    ...
    <svg id="pausebtn" viewBox="0 0 32 32" width="64" height="64" style="display: none;">
